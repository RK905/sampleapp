...
public class AppChecker {
    ...
    private void getForegroundAppAndNotify(Context context) {
        ...
        if (foregroundApp.equalsIgnoreCase("com.instagram.android") || foregroundApp.equalsIgnoreCase("com.facebook.katana")) {
            for (String packageName : listeners.keySet()) {
                if (packageName.equalsIgnoreCase("com.instagram.android") || packageName.equalsIgnoreCase("com.facebook.katana")) {
